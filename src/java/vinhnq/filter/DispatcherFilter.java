...
public class DispatcherFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (url == null) {
                if (requestURI.endsWith(".jsp") || requestURI.endsWith("Servlet"))
                    isDoFilter = true;
                if (!isDoFilter) {
                    List<String> mediaList = (List<String>) request.getServletContext().getAttribute("LIST");
                    if(mediaList != null)
                    {
                        for (String string : mediaList) {
                            if(string.contains(requestURI))
                            {
                                url = requestURI;
                                break;
                            }
            ...
            problem = t;
            log("Throwable_DispatcherFilter: " + t.getMessage());
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            ...
            try {
                ...
                mediaList = HelperUtil.listOfMediaFile(context.getRealPath(""));
                filterConfig.getServletContext().setAttribute("LIST", mediaList);
            } catch (IOException ex) {
                log("IOException_Init_DispatcherFilter: "+ex.getMessage());
            }
        }
    }

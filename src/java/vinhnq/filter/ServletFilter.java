    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (requestURI.endsWith("Servlet")) {
                Map<String, String> map = (Map<String, String>) request.getServletContext().getAttribute("SERVLETMAP");
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            ...
            try {
                ...
                servletMap = HelperUtil.listOfServletFile(context.getRealPath(""));
                filterConfig.getServletContext().setAttribute("SERVLETMAP", servletMap);
            } catch (IOException ex) {
                log("IOException_Init_ServletFilter: " + ex.getMessage());
            }
        }
    }
